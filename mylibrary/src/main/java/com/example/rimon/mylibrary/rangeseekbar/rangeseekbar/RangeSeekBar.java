...
package com.example.rimon.mylibrary.rangeseekbar.rangeseekbar;
...
import com.example.rimon.mylibrary.R;
import com.example.rimon.mylibrary.rangeseekbar.util.BitmapUtil;
import com.example.rimon.mylibrary.rangeseekbar.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#ffeb3b");
    /**
    ...
    public static int LINE_HEIGHT_IN_DP = 75;// line place of changing
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.range_seekbar;
        int thumbPressed = R.drawable.range_seekbar;
        int thumbDisabled = R.drawable.range_seekbar;
        ...
        if (attrs == null) {
            ...
            mDefaultColor = Color.parseColor("#FFE0E0E0");
            mAlwaysActive = false;
            mShowTextAboveThumbs = false;
            mTextAboveThumbsColor = Color.parseColor("#000000");
            ...
            try {
                ...
                mShowTextAboveThumbs = a.getBoolean(R.styleable.RangeSeekBar_valuesAboveThumbs, false);
                mTextAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#000000"));
                ...
                mDefaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, Color.parseColor("#FFE0E0E0"));
